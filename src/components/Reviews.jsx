...
export default function Reviews() {
  ...
  return (
    <div className='flex flex-col items-center px-20 p-4'>
       ...
       <div className='flex flex-col lg:flex-row justify-evenly items-center gap-6'>
            <div className='w-12 h-12 bg-red-400 rounded-full flex justify-center items-center text-white text-2xl' 
            onClick={() => {
              const container = sliderRef.current;
              container.scrollLeft -= scrollAmount; 
            }}
            >{'<'}</div>
              <div className='w-[1280px] flex gap-6 overflow-hidden scroll-smooth  flex-shrink-0 p-4' ref={sliderRef}>
                {displayRevies}
              </div>
            <div className='w-12 h-12 bg-red-400 rounded-full flex justify-center items-center text-white text-2xl'
            onClick={() => {
